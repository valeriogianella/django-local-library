...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, choices=[('EN', 'English'), ('FA', 'Farsi)')], default='EN', help_text='Language of the book', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ...
                ('language', models.ForeignKey(default='EN', on_delete=django.db.models.deletion.RESTRICT, to='catalog.language')),
            ],
            options={
                'ordering': ['due_back'],
            },
